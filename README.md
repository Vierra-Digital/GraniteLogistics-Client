...
| `npm run shots` | renders 46 screens to `shots/` (gitignored) so they can be looked at | both themes, phone and desktop, empty states, worst-case content, and every step of the sign-in and ordering flows |
