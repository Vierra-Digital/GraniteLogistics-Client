...
| `npm run shots` | renders 34 screens to `shots/` (gitignored) so they can be looked at | both themes, phone and desktop, empty states, worst-case content, and states behind an interaction |
